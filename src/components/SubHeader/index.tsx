...
function SubHeader():ReactElement{
    ...
    return(
        <Grid container classes={{root:styles.subHeaderContainer}} alignItems="center">
            <Grid item classes={{root:styles.Title}}
            lg={2}
            md={3}
            sm={4}
            xs={12}
            ...
            <Grid container lg={4} md={5} xs={12} classes={{root:styles.AudienceStyles}} justify="flex-start" >
